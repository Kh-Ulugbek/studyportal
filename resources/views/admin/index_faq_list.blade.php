            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <div class="alert alert-dark" role="alert">
                        ...
                        <h4 class="alert-heading">{{$faq->question}}</h4>
                        <p class="mb-0">
                        {{$faq->answer}}
                        </p>
                    </div>
...
<button type="button" class="btn  btn-icon btn-success waves-effect waves-light" data-toggle="modal" data-target="#addFaqForm">
