...
<head>
    ...
    <title>Admin Login Page - Studyportal.uz</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('afiles')}}/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="{{asset('afiles')}}/app-assets/images/logo/logo-study.png" alt="branding logo">
                            </div>
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    <div class="card-header pb-1">
                                        <div class="card-title">
                                            <h4 class="mb-0">Авторизоваться</h4>
                                        </div>
                                    </div>
                                    <p class="px-2">С возвращением, пожалуйста, войдите в свою учетную запись.</p>
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form method="POST" action="{{ route('login') }}">
                                                @csrf
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" id="user-name" name="login" placeholder="Логин" required autofocus value="{{ old('login') }}">
                                                    @error('login')
                                                ...
                                                <fieldset class="form-label-group position-relative has-icon-left">
                                                    <input type="password" class="form-control" id="user-password" name="password" placeholder="Пароль" required>
                                                    @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <button type="submit" class="btn btn-primary float-right btn-inline">Войти</button>
                                            </form>
                                        </div>
                                    </div>
